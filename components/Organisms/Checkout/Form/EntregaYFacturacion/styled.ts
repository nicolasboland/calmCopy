...
export const ContainerInfoEDE = styled.div`
  display: flex;
  gap: 0.4rem;
  align-items: center;
`;

export const ContEDE = styled.div`
  cursor: pointer;
`

export const BoldLinkEDE = styled.span`
  cursor: pointer;
